...
`~/.claude/scripts/nomess.sh [repo-path]` (defaults to cwd). It reports
...
- Sources: `feedback_never_leave_mess`, `feedback_cross_layer_discipline`,
  `feedback_doc_claims_need_runtime_verification`,
  `feedback_qa_sessions_delete_not_archive`.
