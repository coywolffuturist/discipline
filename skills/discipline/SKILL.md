...
- The bait debt, as of 2026-09-02: `lint/run_baits.py` discovers every tracked
  code form and runs every bait file under an execution trace; 12 bait files
  cover 21 of 30 forms, and the 9 uncovered (`checks.py`, `owe_table`,
  `consistency`, `crumbs`, `retire-identifier`, the four shell scripts) sit in
  `lint/run_baits.baseline`, pinned and shrink-only. Gate 09 disprove-first
  holds the REVISIT.
